...
class AuthController {
  async login(req, res) {
    try {                                                
      const stringifiedParams = queryString.stringify({       //set parameters for google request
  ...
  async redirect(req, res) {
    try {
      ...
      const tokenData = await axios({   //get authorization token from google
      ...
      const userData = await axios({                         //get info about user from google
